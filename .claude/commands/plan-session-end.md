# Session-End Ritual for PDF Reduce to Text Project
...
3. **Apply project-specific configuration**:
   ...
   - **Planning documents**: /mnt/DATA01/include/www.deepily.ai/projects/pdf-reduce-to-text/rnd/
   - **Archive directory**: /mnt/DATA01/include/www.deepily.ai/projects/pdf-reduce-to-text/history/
...
4. **Execute all steps** in sequence:
   ...
   - Step 2: Update planning and tracking documents in rnd/ directory
...
5. **Use notifications** throughout:
   - Send `notify-claude "[PDF-REDUCE] <message>"` after completing each major step
...
- No need to maintain duplicate session-end logic in this project
